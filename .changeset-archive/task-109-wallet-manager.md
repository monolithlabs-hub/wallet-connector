...
TASK-109 — add `createWalletManager(config)` to `@monolithlabs-hub/wallet-connect-core`. This is the canonical public API of the core package — every other Phase 1 module (PlatformDetector, FlowMachine, SessionStore, getSortedWallets, StandardWalletAdapter + discovery, DeepLinkAdapter) wires together here.

...
'@monolithlabs-hub/wallet-connect-react': patch
---

Fix React StrictMode lifecycle bug where `WalletConnectProvider` and `useWallet(config)` threw `WalletManager has been destroyed` after the dev double-mount cycle.

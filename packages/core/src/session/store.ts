 ...
 *
 * Two distinct nonces sit in this same flow — do not conflate them:
 * - {@link PendingState.nonce} (here) is a UUID v4 generated by the dapp
 *   for replay-protection of the redirect leg.
 * - The `nonce` query parameter Phantom puts on the callback URL is a
 *   24-byte XSalsa20 IV the wallet generates for the symmetric decryption.
 *   That one is read by `parseCallback`, not stored here.
 *
